(function(e, t) {
    ...
    function n(e) {
        ...
        }), e.target && ("string" != typeof e.target || document.querySelector(e.target)) && ("string" == typeof e.target || e.target.appendChild) || (g("Target parameter is not valid, defaulting to \"body\""), e.target = "body");
        var t, n = N(),
        ...
        "function" == typeof e.animation && (e.animation = e.animation.call()), e.showCloseButton ? (m.setAttribute("aria-label", e.closeButtonAriaLabel), T(m)) : V(m), t.className = k.popup, e.toast ? (L([document.documentElement, document.body], k["toast-shown"]), L(t, k.toast)) : L(t, k.modal), e.customClass && L(t, e.customClass);
        var y = z(),
            v = parseInt(null === e.currentProgressStep ? Oe.getQueueStep() : e.currentProgressStep, 10);
        e.progressSteps && e.progressSteps.length ? (T(y), q(y), v >= e.progressSteps.length && g("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), e.progressSteps.forEach(function(t, n) {
        ...
        ie(e.footer, f), !0 === e.animation ? O(t, k.noanimation) : L(t, k.noanimation), e.showLoaderOnConfirm && !e.preConfirm && g("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request")
    }
    ...
    var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        ...
        be = function(e) {
            for (var t in e) ge(t) || g("Unknown parameter \"" + t + "\""), he(t) && y("The parameter \"" + t + "\" is deprecated and will be removed in the next major release.")
        },
        ye = {},
        ve = [],
        we = function(e, t) {
    ...
    var Ae = {
        ...
        Se = function(e, t, n) {
            var o = M(),
                i = N();
            null !== t && "function" == typeof t && t(i), e ? (L(i, k.show), L(o, k.fade), O(i, k.hide)) : O(i, k.fade), T(i), o.style.overflowY = "hidden", ae && !E(i, k.noanimation) ? i.addEventListener(ae, function e() {
        ...
        Pe = Object.freeze({
            ...
            getInput: function(e) {
                ...
                return (e = e || t.input, !e) ? null : "select" === e || "textarea" === e || "file" === e ? _(n.content, k[e]) : "checkbox" === e ? n.popup.querySelector("." + k.checkbox + " input") : "radio" === e ? n.popup.querySelector("." + k.radio + " input:checked") || n.popup.querySelector("." + k.radio + " input:first-child") : "range" === e ? n.popup.querySelector("." + k.range + " input") : _(n.content, k.input)
            },
            ...
            _main: function(e) {
                ...
                return new Promise(function(e, n) {
                    ...
                    for (var m = function(e) {
                            ...
                            switch (i.type) {
                                case "click":
                                    if (!(c && l.isVisible())) f && l.isVisible() && (t.disableButtons(), d(l.DismissReason.cancel));
                                        ...
                                        if (o.inputValidator) {
                                            ...
                                            o.expectRejections ? h.then(function() {
                                                ...
                                                t.enableButtons(), t.enableInput(), e ? t.showValidationError(e) : m(g)
                                            }, function(e) {
                                                return u(e)
                                            })
                                        } else m(g)
                        ...
                        }, b = r.popup.querySelectorAll("button"), y = 0; y < b.length; y++) b[y].onclick = g, b[y].onmouseover = g, b[y].onmouseout = g, b[y].onmousedown = g;
                        ...
                        case "select":
                            ...
                            R = function(e) {
                                e.forEach(function(e) {
                                    ...
                                    a.value = n, a.innerHTML = i, o.inputValue.toString() === n.toString() && (a.selected = !0), H.appendChild(a)
                                }), T(H), H.focus()
                            };
                            break;
                        case "radio":
                    ...
                    if ("select" === o.input || "radio" === o.input) {
                        ...
                        B.value = "number" === o.input ? parseFloat(e) || 0 : e + "", T(B), t.hideLoading()
                    }).catch(function(e) {
                        h("Error in inputValue promise: " + e), B.value = "", T(B), t.hideLoading()
                    }));
                    Se(o.animation, o.onBeforeOpen, o.onOpen), o.toast || (v(o.allowEnterKey) ? o.focusCancel && D(r.cancelButton) ? r.cancelButton.focus() : o.focusConfirm && D(r.confirmButton) ? r.confirmButton.focus() : C(-1, 1) : document.activeElement && document.activeElement.blur()), r.container.scrollTop = 0
                })
            }
        }),
        Le = void 0;
