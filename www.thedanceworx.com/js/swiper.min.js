! function() {
    ...
    var a, t, i = function(e, t) {
        ...
        function n() {
            y.autoplayTimeoutId = setTimeout(function() {
                y.params.loop ? (y.fixLoop(), y._slideNext(), y.emit("onAutoplay", y)) : y.isEnd ? t.autoplayStopOnLast ? y.stopAutoplay() : (y._slideTo(0), y.emit("onAutoplay", y)) : (y._slideNext(), y.emit("onAutoplay", y))
            }, y.params.autoplay)
        }
        ...
        function u(e, t) {
            ...
            i = e.attr("data-swiper-parallax") || "0", r = e.attr("data-swiper-parallax-x"), s = e.attr("data-swiper-parallax-y"), r || s ? (r = r || "0", s = s || "0") : y.isHorizontal() ? (r = i, s = "0") : (s = i, r = "0"), r = r.indexOf("%") >= 0 ? parseInt(r, 10) * t * n + "%" : r * t * n + "px", s = s.indexOf("%") >= 0 ? parseInt(s, 10) * t + "%" : s * t + "px", e.transform("translate3d(" + r + ", " + s + ",0px)")
        }
        ...
        var f = {};
        for (var g in t)
            if ("object" != typeof t[g] || null === t[g] || t[g].nodeType || t[g] === window || t[g] === document || void 0 !== r && t[g] instanceof r || "undefined" != typeof jQuery && t[g] instanceof jQuery) f[g] = t[g];
            else
                for (var v in f[g] = {}, t[g]) f[g][v] = t[g][v];
        for (var w in m)
            if (void 0 === t[w]) t[w] = m[w];
            else if ("object" == typeof t[w])
            for (var b in m[w]) void 0 === t[w][b] && (t[w][b] = m[w][b]);
        var y = this;
        if (y.params = t, y.originalParams = f, y.classNames = [], void 0 !== a && void 0 !== r && (a = r), (void 0 !== a || (a = void 0 === r ? window.Dom7 || window.Zepto || window.jQuery : r)) && (y.$ = a, y.currentBreakpoint = void 0, y.getActiveBreakpoint = function() {
            ...
            y.container[0].swiper = y, y.container.data("swiper", y), y.classNames.push("swiper-container-" + y.params.direction), y.params.freeMode && y.classNames.push("swiper-container-free-mode"), y.support.flexbox || (y.classNames.push("swiper-container-no-flexbox"), y.params.slidesPerColumn = 1), y.params.autoHeight && y.classNames.push("swiper-container-autoheight"), (y.params.parallax || y.params.watchSlidesVisibility) && (y.params.watchSlidesProgress = !0), ["cube", "coverflow", "flip"].indexOf(y.params.effect) >= 0 && (y.support.transforms3d ? (y.params.watchSlidesProgress = !0, y.classNames.push("swiper-container-3d")) : y.params.effect = "slide"), "slide" !== y.params.effect && y.classNames.push("swiper-container-" + y.params.effect), "cube" === y.params.effect && (y.params.resistanceRatio = 0, y.params.slidesPerView = 1, y.params.slidesPerColumn = 1, y.params.slidesPerGroup = 1, y.params.centeredSlides = !1, y.params.spaceBetween = 0, y.params.virtualTranslate = !0, y.params.setWrapperSize = !1), ("fade" === y.params.effect || "flip" === y.params.effect) && (y.params.slidesPerView = 1, y.params.slidesPerColumn = 1, y.params.slidesPerGroup = 1, y.params.watchSlidesProgress = !0, y.params.spaceBetween = 0, y.params.setWrapperSize = !1, void 0 === h && (y.params.virtualTranslate = !0)), y.params.grabCursor && y.support.touch && (y.params.grabCursor = !1), y.wrapper = y.container.children("." + y.params.wrapperClass), y.params.pagination && (y.paginationContainer = a(y.params.pagination), "bullets" === y.params.paginationType && y.params.paginationClickable ? y.paginationContainer.addClass("swiper-pagination-clickable") : y.params.paginationClickable = !1, y.paginationContainer.addClass("swiper-pagination-" + y.params.paginationType)), y.isHorizontal = function() {
                ...
                var n;
                e.complete && i ? s() : a ? ((n = new window.Image).onload = s, n.onerror = s, t && (n.srcset = t), a && (n.src = a)) : s()
                ...
                var o, l, p = y.params.slidesPerColumn,
                    d = a / p,
                    u = d - (y.params.slidesPerColumn * d - y.slides.length);
                for (e = 0; e < y.slides.length; e++) {
                    o = 0;
                    var c, m, h, f = y.slides.eq(e);
                    if (y.params.slidesPerColumn > 1) "column" === y.params.slidesPerColumnFill ? (h = e - (m = Math.floor(e / p)) * p, (m > u || m === u && h === p - 1) && ++h >= p && (h = 0, m++), c = m + h * a / p, f.css({
                        "-webkit-box-ordinal-group": c,
                        "-moz-box-ordinal-group": c,
                        "-ms-flex-order": c,
                        "-webkit-order": c,
                        order: c
                    })) : m = e - (h = Math.floor(e / d)) * d, f.css({
                        "margin-top": 0 !== h && y.params.spaceBetween && y.params.spaceBetween + "px"
                    }).attr("data-swiper-column", m).attr("data-swiper-row", h);
                    "none" !== f.css("display") && ("auto" === y.params.slidesPerView ? (o = y.isHorizontal() ? f.outerWidth(!0) : f.outerHeight(!0), y.params.roundLengths && (o = s(o))) : (o = (y.size - (y.params.slidesPerView - 1) * t) / y.params.slidesPerView, y.params.roundLengths && (o = s(o)), y.isHorizontal() ? y.slides[e].style.width = o + "px" : y.slides[e].style.height = o + "px"), y.slides[e].swiperSlideSize = o, y.slidesSizesGrid.push(o), y.params.centeredSlides ? (i = i + o / 2 + r / 2 + t, 0 === e && (i = i - y.size / 2 - t), Math.abs(i) < .001 && (i = 0), n % y.params.slidesPerGroup == 0 && y.snapGrid.push(i), y.slidesGrid.push(i)) : (n % y.params.slidesPerGroup == 0 && y.snapGrid.push(i), y.slidesGrid.push(i), i = i + o + t), y.virtualSize += o + t, r = o, n++)
                }
                if (y.virtualSize = Math.max(y.virtualSize, y.size) + y.params.slidesOffsetAfter, y.rtl && y.wrongRTL && ("slide" === y.params.effect || "coverflow" === y.params.effect) && y.wrapper.css({
                    ...
                    for (l = [], e = 0; e < y.snapGrid.length; e++) y.snapGrid[e] < y.virtualSize + y.snapGrid[0] && l.push(y.snapGrid[e]);
                    y.snapGrid = l
                }
                if (!y.params.centeredSlides) {
                    for (l = [], e = 0; e < y.snapGrid.length; e++) y.snapGrid[e] <= y.virtualSize - y.size && l.push(y.snapGrid[e]);
                    y.snapGrid = l, Math.floor(y.virtualSize - y.size) > Math.floor(y.snapGrid[y.snapGrid.length - 1]) && y.snapGrid.push(y.virtualSize - y.size)
                }
                ...
                if (e.addClass(y.params.slideActiveClass), e.next("." + y.params.slideClass).addClass(y.params.slideNextClass), e.prev("." + y.params.slideClass).addClass(y.params.slidePrevClass), y.paginationContainer && y.paginationContainer.length > 0) {
                    var t, i = y.params.loop ? Math.ceil((y.slides.length - 2 * y.loopedSlides) / y.params.slidesPerGroup) : y.snapGrid.length;
                    if (y.params.loop ? ((t = Math.ceil(y.activeIndex - y.loopedSlides) / y.params.slidesPerGroup) > y.slides.length - 1 - 2 * y.loopedSlides && (t -= y.slides.length - 2 * y.loopedSlides), t > i - 1 && (t -= i), 0 > t && "bullets" !== y.params.paginationType && (t = i + t)) : t = void 0 !== y.snapIndex ? y.snapIndex : y.activeIndex || 0, "bullets" === y.params.paginationType && y.bullets && y.bullets.length > 0 && (y.bullets.removeClass(y.params.bulletActiveClass), y.paginationContainer.length > 1 ? y.bullets.each(function() {
                            a(this).index() === t && a(this).addClass(y.params.bulletActiveClass)
                        }) : y.bullets.eq(t).addClass(y.params.bulletActiveClass)), "fraction" === y.params.paginationType && (y.paginationContainer.find("." + y.params.paginationCurrentClass).text(t + 1), y.paginationContainer.find("." + y.params.paginationTotalClass).text(i)), "progress" === y.params.paginationType) {
                        var r = (t + 1) / i,
                            s = r,
                            n = 1;
                        y.isHorizontal() || (n = r, s = 1), y.paginationContainer.find("." + y.params.paginationProgressbarClass).transform("translate3d(0,0,0) scaleX(" + s + ") scaleY(" + n + ")").transition(y.params.speed)
                    }
                    "custom" === y.params.paginationType && y.params.paginationCustomRender && y.paginationContainer.html(y.params.paginationCustomRender(y, t + 1, i))
                }
            ...
            window.navigator.pointerEnabled ? T = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (T = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), y.touchEvents = {
                ...
                var i = e ? "off" : "on",
                    ...
                    n = y.support.touch ? s : document,
                    o = !!y.params.nested;
                y.browser.ie ? (s[r](y.touchEvents.start, y.onTouchStart, !1), n[r](y.touchEvents.move, y.onTouchMove, o), n[r](y.touchEvents.end, y.onTouchEnd, !1)) : (y.support.touch && (s[r](y.touchEvents.start, y.onTouchStart, !1), s[r](y.touchEvents.move, y.onTouchMove, o), s[r](y.touchEvents.end, y.onTouchEnd, !1)), !t.simulateTouch || y.device.ios || y.device.android || (s[r]("mousedown", y.onTouchStart, !1), document[r]("mousemove", y.onTouchMove, o), document[r]("mouseup", y.onTouchEnd, !1))), window[r]("resize", y.onResize), y.params.nextButton && (a(y.params.nextButton)[i]("click", y.onClickNext), y.params.a11y && y.a11y && a(y.params.nextButton)[i]("keydown", y.a11y.onEnterKey)), y.params.prevButton && (a(y.params.prevButton)[i]("click", y.onClickPrev), y.params.a11y && y.a11y && a(y.params.prevButton)[i]("keydown", y.a11y.onEnterKey)), y.params.pagination && y.params.paginationClickable && (a(y.paginationContainer)[i]("click", "." + y.params.bulletClass, y.onClickIndex), y.params.a11y && y.a11y && a(y.paginationContainer)[i]("keydown", "." + y.params.bulletClass, y.a11y.onEnterKey)), (y.params.preventClicks || y.params.preventClicksPropagation) && s[r]("click", y.preventClicks, !0)
                ...
                if (y.clickedSlide = t, y.clickedIndex = a(t).index(), y.params.slideToClickedSlide && void 0 !== y.clickedIndex && y.clickedIndex !== y.activeIndex) {
                    ...
                    if (y.params.loop) {
                        ...
                        s = a(y.clickedSlide).attr("data-swiper-slide-index"), y.params.centeredSlides ? n < y.loopedSlides - y.params.slidesPerView / 2 || n > y.slides.length - y.loopedSlides + y.params.slidesPerView / 2 ? (y.fixLoop(), n = y.wrapper.children("." + y.params.slideClass + '[data-swiper-slide-index="' + s + '"]:not(.swiper-slide-duplicate)').eq(0).index(), setTimeout(function() {
                            y.slideTo(n)
            ...
            var x, S, C, z, M, P, E, k, I, L, D, H, B = "input, select, textarea, button",
                A = Date.now(),
                G = [];
            if (y.animating = !1, y.touches = {
                    ...
                    if (e.originalEvent && (e = e.originalEvent), !(D && "mousemove" === e.type || e.preventedByNestedSwiper)) {
                        ...
                        if (D && document.activeElement && e.target === document.activeElement && a(e.target).is(B)) return S = !0, void(y.allowClick = !1);
                        if (C && y.emit("onTouchMove", y, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                            ...
                            if (M && y.emit("onTouchMoveOpposite", y, e), void 0 === H && y.browser.ieTouch && (y.touches.currentX !== y.touches.startX || y.touches.currentY !== y.touches.startY) && (H = !0), x) {
                                if (M) return void(x = !1);
                                if (H || !y.browser.ieTouch) {
                                    y.allowClick = !1, y.emit("onSliderMove", y, e), e.preventDefault(), y.params.touchMoveStopPropagation && !y.params.nested && e.stopPropagation(), S || (t.loop && y.fixLoop(), E = y.getWrapperTranslate(), y.setWrapperTransition(0), y.animating && y.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), y.params.autoplay && y.autoplaying && (y.params.autoplayDisableOnInteraction ? y.stopAutoplay() : y.pauseAutoplay()), L = !1, y.params.grabCursor && (y.container[0].style.cursor = "move", y.container[0].style.cursor = "-webkit-grabbing", y.container[0].style.cursor = "-moz-grabbin", y.container[0].style.cursor = "grabbing")), S = !0;
                                    var r = y.touches.diff = y.isHorizontal() ? y.touches.currentX - y.touches.startX : y.touches.currentY - y.touches.startY;
                                    r *= y.params.touchRatio, y.rtl && (r = -r), y.swipeDirection = r > 0 ? "prev" : "next", P = r + E;
                                    var s = !0;
                                    if (r > 0 && P > y.minTranslate() ? (s = !1, y.params.resistance && (P = y.minTranslate() - 1 + Math.pow(-y.minTranslate() + E + r, y.params.resistanceRatio))) : 0 > r && P < y.maxTranslate() && (s = !1, y.params.resistance && (P = y.maxTranslate() + 1 - Math.pow(y.maxTranslate() - E - r, y.params.resistanceRatio))), s && (e.preventedByNestedSwiper = !0), !y.params.allowSwipeToNext && "next" === y.swipeDirection && E > P && (P = E), !y.params.allowSwipeToPrev && "prev" === y.swipeDirection && P > E && (P = E), y.params.followFinger) {
                                        if (y.params.threshold > 0) {
                                            if (!(Math.abs(r) > y.params.threshold || k)) return void(P = E);
                                            if (!k) return k = !0, y.touches.startX = y.touches.currentX, y.touches.startY = y.touches.currentY, P = E, void(y.touches.diff = y.isHorizontal() ? y.touches.currentX - y.touches.startX : y.touches.currentY - y.touches.startY)
                    ...
                    if (e.originalEvent && (e = e.originalEvent), C && y.emit("onTouchEnd", y, e), C = !1, x) {
                        ...
                        var t, i = Date.now(),
                            r = i - z;
                        if (y.allowClick && (y.updateClickedSlide(e), y.emit("onTap", y, e), 300 > r && i - A > 300 && (I && clearTimeout(I), I = setTimeout(function() {
                            ...
                            }, 300)), 300 > r && 300 > i - A && (I && clearTimeout(I), y.emit("onDoubleTap", y, e))), A = Date.now(), setTimeout(function() {
                                y && (y.allowClick = !0)
                            }, 0), !x || !S || !y.swipeDirection || 0 === y.touches.diff || P === E) return void(x = S = !1);
                        if (x = S = !1, t = y.params.followFinger ? y.rtl ? y.translate : -y.translate : -P, y.params.freeMode) {
                            if (t < -y.minTranslate()) return void y.slideTo(y.activeIndex);
                            if (t > -y.maxTranslate()) return void(y.slides.length < y.snapGrid.length ? y.slideTo(y.snapGrid.length - 1) : y.slideTo(y.slides.length - 1));
                            if (y.params.freeModeMomentum) {
                                ...
                                if (u < y.maxTranslate()) y.params.freeModeMomentumBounce ? (u + y.maxTranslate() < -h && (u = y.maxTranslate() - h), c = y.maxTranslate(), m = !0, L = !0) : u = y.maxTranslate();
                                else if (u > y.minTranslate()) y.params.freeModeMomentumBounce ? (u - y.minTranslate() > h && (u = y.minTranslate() + h), c = y.minTranslate(), m = !0, L = !0) : u = y.minTranslate();
                                ...
                                y.params.freeModeMomentumBounce && m ? (y.updateProgress(c), y.setWrapperTransition(p), y.setWrapperTranslate(u), y.onTransitionStart(), y.animating = !0, y.wrapper.transitionEnd(function() {
                                    y && L && (y.emit("onMomentumBounce", y), y.setWrapperTransition(y.params.speed), y.setWrapperTranslate(c), y.wrapper.transitionEnd(function() {
                                        y && y.onTransitionEnd()
                                    }))
                        ...
                        for (v = 0; v < y.slidesGrid.length; v += y.params.slidesPerGroup) void 0 !== y.slidesGrid[v + y.params.slidesPerGroup] ? t >= y.slidesGrid[v] && t < y.slidesGrid[v + y.params.slidesPerGroup] && (w = v, b = y.slidesGrid[v + y.params.slidesPerGroup] - y.slidesGrid[v]) : t >= y.slidesGrid[v] && (w = v, b = y.slidesGrid[y.slidesGrid.length - 1] - y.slidesGrid[y.slidesGrid.length - 2]);
                        var T = (t - y.slidesGrid[w]) / b;
                    ...
                    return void 0 === a && (a = "x"), y.params.virtualTranslate ? y.rtl ? -y.translate : y.translate : (r = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? ((i = r.transform || r.webkitTransform).split(",").length > 6 && (i = i.split(", ").map(function(e) {
                        return e.replace(",", ".")
                    }).join(", ")), s = new window.WebKitCSSMatrix("none" === i ? "" : i)) : t = (s = r.MozTransform || r.OTransform || r.MsTransform || r.msTransform || r.transform || r.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === a && (i = window.WebKitCSSMatrix ? s.m41 : 16 === t.length ? parseFloat(t[12]) : parseFloat(t[4])), "y" === a && (i = window.WebKitCSSMatrix ? s.m42 : 16 === t.length ? parseFloat(t[13]) : parseFloat(t[5])), y.rtl && i && (i = -i), i || 0)
                    ...
                    for (e.each(function(t, s) {
                            var n = a(this);
                            t < y.loopedSlides && r.push(s), t < e.length && t >= e.length - y.loopedSlides && i.push(s), n.attr("data-swiper-slide-index", t)
                        ...
                        setTranslate: function() {
                            for (var e = 0; e < y.slides.length; e++) {
                                ...
                                if (y.isHorizontal() ? y.rtl && (r = -r) : (o = n, n = 0, s = -r, r = 0), t[0].style.zIndex = -Math.abs(Math.round(i)) + y.slides.length, y.params.flip.slideShadows) {
                                    ...
                                    0 === l.length && (l = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>'), t.append(l)), 0 === p.length && (p = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'), t.append(p)), l.length && (l[0].style.opacity = Math.max(-i, 0)), p.length && (p[0].style.opacity = Math.max(i, 0))
                                }
                    ...
                    cube: {
                        setTranslate: function() {
                            var e, t = 0;
                            y.params.cube.shadow && (y.isHorizontal() ? (0 === (e = y.wrapper.find(".swiper-cube-shadow")).length && (e = a('<div class="swiper-cube-shadow"></div>'), y.wrapper.append(e)), e.css({
                                height: y.width + "px"
                            })) : 0 === (e = y.container.find(".swiper-cube-shadow")).length && (e = a('<div class="swiper-cube-shadow"></div>'), y.container.append(e)));
                    ...
                    coverflow: {
                        setTranslate: function() {
                            for (var e = y.translate, t = y.isHorizontal() ? -e + y.width / 2 : -e + y.height / 2, i = y.isHorizontal() ? y.params.coverflow.rotate : -y.params.coverflow.rotate, r = y.params.coverflow.depth, s = 0, n = y.slides.length; n > s; s++) {
                                var o = y.slides.eq(s),
                                ...
                                if (o.transform(f), o[0].style.zIndex = 1 - Math.abs(Math.round(p)), y.params.coverflow.slideShadows) {
                                    ...
                                    0 === g.length && (g = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>'), o.append(g)), 0 === v.length && (v = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'), o.append(v)), g.length && (g[0].style.opacity = p > 0 ? p : 0), v.length && (v[0].style.opacity = -p > 0 ? -p : 0)
                                }
                            }
                    ...
                    loadImageInSlide: function(e, t) {
                        if (void 0 !== e && (void 0 === t && (t = !0), 0 !== y.slides.length)) {
                            var i = y.slides.eq(e),
                            ...
                            !i.hasClass("swiper-lazy") || i.hasClass("swiper-lazy-loaded") || i.hasClass("swiper-lazy-loading") || (r = r.add(i[0])), 0 !== r.length && r.each(function() {
                                ...
                                y.loadImage(e[0], s || r, n, !1, function() {
                                    if (r ? (e.css("background-image", "url(" + r + ")"), e.removeAttr("data-background")) : (n && (e.attr("srcset", n), e.removeAttr("data-srcset")), s && (e.attr("src", s), e.removeAttr("data-src"))), e.addClass("swiper-lazy-loaded").removeClass("swiper-lazy-loading"), i.find(".swiper-lazy-preloader, .preloader").remove(), y.params.loop && t) {
                    ...
                    load: function() {
                        ...
                        if (y.params.lazyLoadingInPrevNext)
                            if (y.params.slidesPerView > 1 || y.params.lazyLoadingInPrevNextAmount && y.params.lazyLoadingInPrevNextAmount > 1) {
                                ...
                                for (e = s; e < y.activeIndex; e++) y.slides[e] && y.lazy.loadImageInSlide(e)
                            } else {
                    ...
                    setTranslate: function(e, a) {
                        ...
                        if (y.isArray(n))
                            for (var o = 0; o < n.length; o++) n[o] !== a && n[o] instanceof i && t(n[o]);
                        else n instanceof i && a !== n && t(n)
                    },
                    setTransition: function(e, a) {
                        ...
                        if (y.isArray(s))
                            for (r = 0; r < s.length; r++) s[r] !== a && s[r] instanceof i && t(s[r]);
                        else s instanceof i && a !== s && t(s)
                    }
                }, y.hashnav = {
                    init: function() {
                        if (y.params.hashnav) {
                    ...
                    y.params.keyboardControl = !1, a(document).off("keydown", p)
                }, y.enableKeyboardControl = function() {
                    y.params.keyboardControl = !0, a(document).on("keydown", p)
                }, y.mousewheel = {
                    event: !1,
            ...
            for (var O in y.disableMousewheelControl = function() {
                ...
                var N = y.plugins[O](y, y.params[O]);
                N && y._plugins.push(N)
            }
    ...
    for (var r = function() {
            ...
            return e.prototype = {
                ...
                once: function(e, a, t, i) {
                    var r = this;
                    "function" == typeof a && (a = !1, t = arguments[1], i = arguments[2]), r.on(e, a, function s(n) {
                        t(n), r.off(e, a, s, i)
                    }, i)
                },
                ...
                eq: function(a) {
                    ...
                    var t, i = this.length;
                    return a > i - 1 ? new e([]) : 0 > a ? new e(0 > (t = i + a) ? [] : [this[t]]) : new e([this[a]])
                },
                append: function(a) {
                    var t, i;
                    for (t = 0; t < this.length; t++)
    ...
    (t = void 0 === r ? window.Dom7 || window.Zepto || window.jQuery : r) && ("transitionEnd" in t.fn || (t.fn.transitionEnd = function(e) {
        function a(s) {
            if (s.target === this)
                for (e.call(this, s), t = 0; t < i.length; t++) r.off(i[t], a)
        }
