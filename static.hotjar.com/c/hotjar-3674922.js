window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["survey.image_question", "error_reporting", "feedback.widgetV2", "settings.billing_v2", "survey.type_button", "feedback.embeddable_widget", "ask.popover_redesign", "survey.screenshots", "survey.embeddable_widget", "client_script.compression.pc"],
...
! function() {
            ...
            start: function() {
                try {
                    ...
                    return d.genericTags = {
                        site_id: r
                    }, d.isDebugEnabled = Math.random() <= a.universalDebug || s.has("client_script.metrics.debug") && Math.random() <= a.debug, d.isMetricsEnabled = Math.random() <= a.metrics, d.isFieldMetricsEnabled = d.isMetricsEnabled && Math.random() <= a.fieldMetrics, o = new i(m, l.buffer.bufferSize, l.buffer.flushInterval), e
                } catch (e) {
            ...
            count: function(e, t) {
                ...
                try {
                    var c, u = h(r),
                        l = d.loggedMetrics[e],
                        f = 0;
                    if (n ? (f = (l && l[u] || 0) + (n.value || 1), d.loggedMetrics[e] = s(s({}, l), {}, ((c = {})[u] = null != n && n.flush ? 0 : f, c))) : f = 1, p(a, n)) {
                        var m = {
                            name: e,
                            type: "count",
                            value: f,
    ...
    var b, w, j, _, y, S, E = hj.metrics.start(),
        T = !(!window.CS_CONF || null === (a = window.CS_CONF.voc) || void 0 === a || !a.enabled),
    ...
    if (window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
                js: "survey-v2.db3ff4337be14b0b5ac0.js"
            },
            SURVEY_BOOTSTRAPPER: {
                js: "survey-bootstrapper.5a85193a3fad2f251abc.js"
            },
            SURVEY_ISOLATED: {
                js: "survey-isolated.6c1feb15736ec9c3aa4a.js"
            },
            HEATMAP_RETAKER: {
                js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js"
            },
            SURVEY_INVITATION: {
                js: "survey-invitation.1197fdfaac5b14f68efc.js"
            },
            NOTIFICATION: {
            ...
            USER_TEST: {
                js: "user-test.b2423fe133402dc80f21.js"
            }
        }, T) window._uxa.push(["start:hotjar", window.hjSiteSettings]);
    else if (M) {
        window.CS_CONF_BASE = (S = (y = (b = window.hjSiteSettings).suppress_all || b.suppress_text || (null === (w = b.suppress_all_on_specific_pages) || void 0 === w ? void 0 : w.length)) ? function(e) {
            var t, n, r, i, s, o;
            if ((e.suppress_all || e.suppress_text) && (n = ".*"), null !== (t = e.suppress_all_on_specific_pages) && void 0 !== t && t.length) {
                var a = e.suppress_all_on_specific_pages.find((function(e) {
                    return "regex" === e.match_operation
                }));
                a && (n = null == a ? void 0 : a.pattern), i = e.suppress_all_on_specific_pages, s = {
                    contains: "contain",
                    ends_with: "end",
                    exact: "exact",
                    simple: "contain",
            ...
            projectId: b.cs_project_id,
            hostnames: [window.location.hostname],
            sampleRate: b.continuous_capture_enabled ? 100 : 100 * b.rec_value,
            replayRecordingRate: b.record ? 100 : 0,
            jsErrorsEnabled: b.session_capture_console_consent,
            customError: b.session_capture_console_consent && {
                enabled: !0,
                consoleMessageLogLevels: ["error"]
            },
            voc: null !== (j = b.feedback_widgets) && void 0 !== j && j.length || null !== (_ = b.polls) && void 0 !== _ && _.length ? {
                enabled: 1,
                siteId: b.site_id
            } : {
                enabled: 0
            },
            whitelistedAttributes: !y && b.recording_capture_keystrokes ? ["data-hj-allow"] : [],
            anonymisationMethod: S,
            anonymizeDigits: !!y || b.anonymize_digits,
            anonymizeEmails: !!y || b.anonymize_emails
        ...
        var o = "http:" === window.location.protocol,
            a = Boolean(window._hjSettings.preview);
        if (o && !a) return hj.metrics.count("session-rejection", {
            tag: {
                reason: "https"
            }
        ...
        d.async = 1, d.src = hj.scriptDomain + t, d.charset = "utf-8", l.appendChild(d), c.revision = "bb592f1", window.hjBootstrap = c
    }, window.hjBootstrap("https://script.hotjar.com/", "modules.8da33a8f469c3b5ffcec.js", "3674922"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: E,
